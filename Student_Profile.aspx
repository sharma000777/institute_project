<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Student_Profile.aspx.cs" Inherits="Admin_Student_Profile" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Student Profile | Institute Management Software</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div class="card mb-6">
                <div class="card-body pt-12">
                    ...
                    <div class="d-flex justify-content-center mb-5">
                        <a href="javascript:;" id="BtnEdit" class="btn btn-primary me-4">Edit</a>
                    ...
                    <div class="info-container">
                        <ul class="list-unstyled mb-6">
                            ...
                            <li class="mb-2">
    <span class="h6">Aadhaar:</span>
    <button id="btnViewAadhaar" class="btn btn-sm btn-primary ms-2">
        View Aadhaar
    </button>
</li>
                            ...
                            <li class="mb-2">
    <span class="h6">Student ID Card:</span>

    <button id="btnGenerateIDCard" class="btn btn-sm btn-primary ms-2">
        View ID Card
    </button>
</li>
    ...
    <button id="btnGenerateCertificate" class="btn btn-sm btn-success ms-2">
        Generate Certificate
    </button>

    <button id="btnViewCertificate" class="btn btn-sm btn-info ms-2">
        View Certificate
    </button>
        ...
        <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
            ...
            <div class="nav-align-top">
                <ul class="nav nav-pills flex-column flex-md-row flex-wrap mb-6 row-gap-2">
                    <li class="nav-item"><a class="nav-link active" id="Nav_Profile" href="javascript:void(0);"><i class="ri-group-line me-1_5"></i>Profile</a></li>
                    ...
                    <li class="nav-item"><a class="nav-link" id="Nav_DuesInstallment" href="javascript:void(0);"><i class="ri-hand-coin-line me-1_5"></i>Dues Installment</a></li>
                </ul>
            </div>
            <!--/ User Tabs -->
            ...
            <div class="card mb-6">
                ...
                <div class="card-body">
                    <div class="table-responsive text-nowrap">
                        <table class="table nowrap" id="tblCourse">
                            <caption class="ms-4">
                                List of Course
                            </caption>
                            <thead>
            ...
            <div class="card mb-6">
                ...
                <div class="card-body">
                    <div class="table-responsive text-nowrap">
                        <table class="table nowrap" id="tblFee">
                            <caption class="ms-4">
                                List of Fee
                            </caption>
                            <thead>
            ...
            <!-- My Installment table -->
            <div class="card mb-6 hide" id="MyInstallmentDiv">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <div class="avatar" style="width: 3.5rem;">
                        ...
                        <div class="ms-3">
                            <p class="mb-0">My Installment Plan</p>
                            <h5 class="mb-0"></h5>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-12">
                            <div class="row g-4">
                                <div class="col-4">
                                    ...
                                    <p class="fw-medium mb-0">₹ <span id="lblMyInstallmentAmount"></span></p>
                                </div>
                                <div class="col-4">
                                    <div class="d-flex align-items-center justify-content-center mb-1">
                                        <div class="badge badge-dot bg-primary me-2"></div>
                                    ...
                                    <p class="fw-medium mb-0"><span id="lblMyInstallmentNo"></span></p>
                                </div>
                                <div class="col-4">
                                    <div class="d-flex align-items-center justify-content-center mb-1">
                                        <div class="badge badge-dot bg-primary me-2"></div>
                                    ...
                                    <p class="fw-medium mb-0">₹ <span id="lblMyTotalAmount"></span></p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        ...
        let SearchMobile, MyInstallmentDiv, MyInstallmentAmount, MyInstallmentNo, MyTotalAmount;
        ...
        $(document).ready(function () {
            ...
            MyInstallmentDiv = $("#MyInstallmentDiv");
            MyInstallmentAmount = $("#lblMyInstallmentAmount");
            MyInstallmentNo = $("#lblMyInstallmentNo");
            MyTotalAmount = $("#lblMyTotalAmount");
            ...
            // Aadhaar View Button Click
            $(document).on("click", "#btnViewAadhaar", function () {

                if (!AadhaarFileName) {
                    Swal.fire("Not Uploaded", "Aadhaar not uploaded", "warning");
                    return;
                }

                window.open("ViewAadhaar.ashx?file=" + AadhaarFileName, "_blank");
            });

            $(document).on("click", "#btnGenerateCertificate", GenerateCertificate);
            $(document).on("click", "#btnViewCertificate", ViewCertificate);
            $(document).on("click", "#btnGenerateIDCard", function () {

                window.open("Student_IDCard.aspx?Mobile=" + SearchMobile, "_blank");

            });
            $(document).on("click", "#BtnEdit", function () {

                window.location.href = "Edit_Student.aspx?Mobile=" + SearchMobile;

            });
            $("#BtnSearchStudent").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: "Student_Profile.aspx/Get_Student",
                        type: "GET",
                        data: {
                            term: request.term
                        },
        ...
        async function GenerateCertificate() {
            ...
            const result = await Confirm("Generate Certificate", "Are you sure?");
            ...
            try {
                ...
                const response = await Ajax_GetResult("Student_Profile.aspx", "Generate_Certificate", dataToSend);

                if (response.d == "SUCCESS") {

                    Success("Generated", "Certificate Generated Successfully");
        ...
        async function renderSearchMobile() {
            try {
                const response = await Ajax_GetResult_WithoutParameter("Student_Profile.aspx", "Get_SearchMobile");
        ...
        async function renderStudent() {
            try {
                ...
                const response = await Ajax_GetResult("Student_Profile.aspx", "Get_Student", dataToSend);
                const data = JSON.parse(response.d);
                if (data.length > 0) {
                    console.log(data);
                    ...
                    // Aadhaar file store
                    AadhaarFileName = data[0]["AadhaarFile"] || "";
        ...
        function ViewCertificate() {
            ...
            window.open("Certificate_Print.aspx?Mobile=" + SearchMobile, "_blank");
        ...
        async function OnClick_BtnDropout() {
            const result = await Confirm("Yes, Drop Student!", "Are you sure want to Dropout?");
            if (result.isConfirmed) {
                try {
                    Show_Spinner();
        ...
        async function renderCourseDetail() {
            try {
                ...
                var url = "Student_Profile.aspx/Get_Course_Master?" + dataToSend;
                await GetCourse(url);
            } catch (err) {
                console.log(err);
            }
        ...
        async function renderFeeDetail() {
            try {
                var parameters = {
                    Mobile: SearchMobile
                };
                ...
                // Remove the trailing '&' character
                dataToSend = dataToSend.slice(0, -1);
                var url = "Student_Profile.aspx/Get_fee?" + dataToSend;
                await GetFee(url);
            } catch (err) {
                console.log(err);
            }
        ...
        async function GetFee(url) {
            ...
            try {
                return new Promise((resolve, reject) => {
                    table = $('#tblFee').DataTable();

                    if ($.fn.DataTable.isDataTable('#tblFee')) {
                        table.destroy();
                    ...
                    table = $('#tblFee').DataTable(
                        {
                            ...
                            "columns": [
                                ...
                                { "data": "DuesAmount", "name": "DuesAmount", "autoWidth": true },
        ...
        async function renderMyInstallment() {
            try {
                ...
                if (response.d > 0) {
                    MyInstallmentDiv.removeClass("hide");
                    const response1 = await Ajax_GetResult("Student_Profile.aspx", "fetchMyInstallment", dataToSend);
                    const data1 = JSON.parse(response1.d);
                    if (data1.length > 0) {
                        MyInstallmentAmount.html(data1[0].Installment_Amount);
                        MyInstallmentNo.html(data1[0].Total_Installment);
                        MyTotalAmount.html(data1[0].Total_Amount);
                    }

                }
                else {
                    MyInstallmentDiv.addClass("hide");
                }
            } catch (err) {
                console.log(err);
            }
