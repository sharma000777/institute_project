<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Student_Batch.aspx.cs" Inherits="Admin_Student_Batch" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Batch Info | Institute Management Software</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
            ...
            <div class="nav-align-top">
                <ul class="nav nav-pills flex-column flex-md-row flex-wrap mb-6 row-gap-2">
                    ...
                    <li class="nav-item"><a class="nav-link active" id="Nav_BatchInfo" href="javascript:void(0);" style="background-color:#433c50"><i class="ri-bookmark-line me-1_5"></i>Batch Info</a></li>
            ...
            <div class="card mb-6">
                <div class="card-body">
                    <div class="row g-6" id="repeatBatchDetail">
                        <div class="col-xxl-6 col-xl-7 col-lg-8 col-md-12">
                            <div class="card">
                                <div class="card-header pb-4" style="background: #433c50 !important;">
                                    <div class="d-flex align-items-start">
                                        <div class="d-flex align-items-center">
                                            <div class="avatar me-4">
                                                <img src="../UserLogin_Content/assets/img/icons/unicons/chart.png" alt="Avatar" class="rounded-circle" style="background: #767373;">
                                            </div>
                                            <div class="me-2">
                                                <h5 class="mb-0"><a href="javascript:;" class="stretched-link text-heading" style="color: white !important">Batch 1</a></h5>
                                                <div class="client-info text-body" style="color: white !important"><span class="fw-medium">Course: </span><span>MCA New</span></div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="">
                                        <div class="d-flex align-items-center">
                                            <div class="bg-lighter px-3 py-2 rounded me-auto mb-4">
                                                <span class="text-body">Session</span>
                                            </div>
                                            <div class="text-start mb-4">
                                                <p class="mb-1"><span class="fw-medium text-heading">2024-09</span> <span>- 2025-09</span></p>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center">
                                            <div class="bg-lighter px-3 py-2 rounded me-auto mb-4">
                                                <span class="text-body">Start Date</span>
                                            </div>
                                            <div class="text-start mb-4">
                                                <p class="mb-1"><span class="fw-medium text-heading">05-09-2024</span></p>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center">
                                            <div class="bg-lighter px-3 py-2 rounded me-auto mb-4">
                                                <span class="text-body">Batch Time</span>
                                            </div>
                                            <div class="text-start mb-4">
                                                <p class="mb-1"><span class="fw-medium text-heading">13:30</span></p>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center mb-4">
                                            <span class="badge bg-label-info ms-auto rounded-pill">Scheduled</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-footer" style="background: #433c50 !important;"></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        let SearchMobile, repeatBatchDetail;
        ...
        $(document).ready(function () {
            ...
            repeatBatchDetail = $("#repeatBatchDetail");
        ...
        async function renderSearchMobile() {
            try {
                const response = await Ajax_GetResult_WithoutParameter("Student_Batch.aspx", "Get_SearchMobile");
        ...
        async function renderStudent() {
            try {
                ...
                const response = await Ajax_GetResult("Student_Batch.aspx", "Get_Student", dataToSend);
                const data = JSON.parse(response.d);
                if (data.length > 0) {
                    console.log(data);
        ...
        async function renderBatchDetail() {
            try {
                ...
                const response = await Ajax_GetResult("Student_Batch.aspx", "fetch_BatchDetail", dataToSend);
                const data = JSON.parse(response.d);
                if (data.length > 0) {
                    console.log(data);

                    var html = "";
                    repeatBatchDetail.empty();
                                    ...
                                    <div class="card-header pb-4" style="background: #433c50 !important;">
                                        <div class="d-flex align-items-start">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="me-2">
                                                    <h5 class="mb-0"><a href="javascript:;" class="stretched-link text-heading" style="color: white !important">${item.BatchName}</a></h5>
                                                    <div class="client-info text-body" style="color: white !important"><span class="fw-medium">Course: </span><span>${item.Course_Name}</span></div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-body" style="padding-top: 20px">
                                        <div class="">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="text-start mb-4">
                                                    <p class="mb-1"><span class="fw-medium text-heading">${item.SessionStart}</span> <span>- ${item.SessionEnd}</span></p>
                                                </div>
                                            </div>
                                            <div class="d-flex align-items-center">
                                                <div class="bg-lighter px-3 py-2 rounded me-auto mb-4">
                                                ...
                                                <div class="text-start mb-4">
                                                    <p class="mb-1"><span class="fw-medium text-heading">${item.StartDate}</span></p>
                                                </div>
                                            </div>
                                            <div class="d-flex align-items-center">
                                                <div class="bg-lighter px-3 py-2 rounded me-auto mb-4">
                                                    <span class="text-body">Batch Duration</span>
                                                </div>
                                                <div class="text-start mb-4">
                                                    <p class="mb-1"><span class="fw-medium text-heading">${item.BatchStartTime} - ${item.BatchEndTime}</span></p>
                                                </div>
                                            </div>
                                            <div class="d-flex align-items-center mb-4">
                                                <span class="badge bg-label-${Status} ms-auto rounded-pill">${item.Status}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-footer" style="background: #433c50 !important;"></div>
